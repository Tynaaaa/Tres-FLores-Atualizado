document.body.style.backgroundImage = "url('imagens/inicio.gif')";
let cenarios = 0;
...
//CRIAÇÂO DAS DIVs PRINCIPAIS
    ...
    document.body.appendChild(divSuperior);
    ...
    document.body.appendChild(divIntermediaria);
...
//MOVIMENTAÇÂO ENTRE TELA INICIAL E INFORMAÇÔES
    ...
    imgInferior.addEventListener('click', () => {
        document.body.style.backgroundImage = "url('imagens/informacoes.gif')";
        ocultarImagens();
...
//MOVIMENTAÇÕES JOGO
    ...
    //Cenários - JOGO
            ...
            if (cenarios === 2){
                document.body.style.backgroundImage = "url('imagens/cenarioDois.png')";
                console.log(cenarios);
            }
        
            if (cenarios === 3){
                document.body.style.backgroundImage = "url('imagens/cenarioTres.gif')";
                console.log(cenarios);
            }
            ...
            if (cenarios === 4){
                ...
                document.body.style.backgroundImage = "url('imagens/preto.png')";
                somPassos.play();
                console.log(cenarios);
                somPassos.addEventListener("ended", function() {
                    imgContinuar.style.display = 'block';
                    document.body.style.backgroundImage = "url('imagens/cenarioQuatro.png')";
                });
            }
            ...
            if (cenarios === 5){
                ...
                somMedo.addEventListener("ended", function() {
                    document.body.style.backgroundImage = "url('imagens/cenarioGuerra.png')";
                    somBatalha.play(); });
                console.log(cenarios);
            }
    ...
    imgJogar.addEventListener('click', () => {
        cenarios = cenarios + 1;
        document.body.style.backgroundImage = "url('imagens/cenarioUm.gif')";
        ocultarImagens();    
        imgInferior.replaceWith(imgContinuar);    
        imgContinuar.style.display = 'block';
        console.log(cenarios);
